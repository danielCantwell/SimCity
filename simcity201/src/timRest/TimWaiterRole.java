...
public class WaiterAgent extends Agent implements Waiter{
	...
	public void msgSeatAtTable(Customer customer, int table, Point tablePos)
	{
		MyCustomer c = new MyCustomer(customer, table, tablePos);
	...
	private void DoSeatCustomer(MyCustomer customer) {
		...
		//Same with "table"
		print("Seating " + customer.customerRef + " at " + customer.tableNumber);
		waiterGui.GoToTable(customer.tablePos); 
	}
	...
	private class MyCustomer
	{
		...
		MyCustomer(Customer c, int t, Point tablePos)
		{
			customerRef = c;
			tableNumber = t;
